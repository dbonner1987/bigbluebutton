...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/chriswessels:hammer/jquery.hammer.js                                                                      //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
(function(factory) {                                                                                                  // 1
    if (typeof define === 'function' && define.amd) {                                                                 // 2
        define(['jquery', 'hammerjs'], factory);                                                                      // 3
    } else if (typeof exports === 'object') {                                                                         // 4
        factory(require('jquery'), require('hammerjs'));                                                              // 5
    } else {                                                                                                          // 6
        factory(jQuery, Hammer);                                                                                      // 7
    }                                                                                                                 // 8
}(function($, Hammer) {                                                                                               // 9
    function hammerify(el, options) {                                                                                 // 10
        var $el = $(el);                                                                                              // 11
        if(!$el.data("hammer")) {                                                                                     // 12
            $el.data("hammer", new Hammer($el[0], options));                                                          // 13
        }                                                                                                             // 14
    }                                                                                                                 // 15
                                                                                                                      // 16
    $.fn.hammer = function(options) {                                                                                 // 17
        return this.each(function() {                                                                                 // 18
            hammerify(this, options);                                                                                 // 19
        });                                                                                                           // 20
    };                                                                                                                // 21
                                                                                                                      // 22
    // extend the emit method to also trigger jQuery events                                                           // 23
    Hammer.Manager.prototype.emit = (function(originalEmit) {                                                         // 24
        return function(type, data) {                                                                                 // 25
            originalEmit.call(this, type, data);                                                                      // 26
            $(this.element).trigger({                                                                                 // 27
                type: type,                                                                                           // 28
                gesture: data                                                                                         // 29
            });                                                                                                       // 30
        };                                                                                                            // 31
    })(Hammer.Manager.prototype.emit);                                                                                // 32
}));                                                                                                                  // 33
                                                                                                                      // 34
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                     // 2546
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/chriswessels:hammer/template_integration.js                                                               //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var gestureHandlers = {};                                                                                             // 1
                                                                                                                      // 2
function getTopSelector (element) {                                                                                   // 3
  var path = element.parents().addBack();                                                                             // 4
  var quickCss = path.get().map(function (item) {                                                                     // 5
    var self = $(item),                                                                                               // 6
        id = item.id ? '#' + item.id : '',                                                                            // 7
        clss = item.classList.length ? item.classList.toString().split(' ').map(function (c) {                        // 8
          return '.' + c;                                                                                             // 9
        }).join('') : '',                                                                                             // 10
        name = item.nodeName.toLowerCase(),                                                                           // 11
        index = self.siblings(name).length ? ':nth-child(' + (self.index() + 1) + ')' : '';                           // 12
                                                                                                                      // 13
        if (name === 'html' || name === 'body') {                                                                     // 14
          return name;                                                                                                // 15
        }                                                                                                             // 16
        return name + index + id + clss;                                                                              // 17
  }).join(' > ');                                                                                                     // 18
  return quickCss;                                                                                                    // 19
}                                                                                                                     // 20
                                                                                                                      // 21
function checkGestureMap (gestureMap) {                                                                               // 22
  if (gestureMap && typeof gestureMap === 'object' && Object.keys(gestureMap).length > 0) {                           // 23
    return _.every(Object.keys(gestureMap), function (actionString) {                                                 // 24
      return !!extractAction(actionString) && typeof gestureMap[actionString] === 'function';                         // 25
    });                                                                                                               // 26
  } else {                                                                                                            // 27
    return false;                                                                                                     // 28
  }                                                                                                                   // 29
}                                                                                                                     // 30
function extractAction (actionString) {                                                                               // 31
  var output = [];                                                                                                    // 32
  function extractSubAction (subActionString) {                                                                       // 33
    var pieces = subActionString.split(' ');                                                                          // 34
    if (pieces.length > 1) {                                                                                          // 35
      output.push({                                                                                                   // 36
        gestureName: pieces[0],                                                                                       // 37
        elementSelector: pieces.slice(1, pieces.length).join(' ')                                                     // 38
      });                                                                                                             // 39
      return true;                                                                                                    // 40
    } else {                                                                                                          // 41
      return false;                                                                                                   // 42
  ...
  if (actionString.indexOf(',') !== -1) {                                                                             // 45
    var subActionStrings = actionString.split(',');                                                                   // 46
    _.each(subActionStrings, function (subActionString) {                                                             // 47
      extractSubAction(subActionString.trim());                                                                       // 48
    });                                                                                                               // 49
    if (output.length > 0) {                                                                                          // 50
      return output;                                                                                                  // 51
    } else {                                                                                                          // 52
      return false;                                                                                                   // 53
    }                                                                                                                 // 54
  } else if (extractSubAction(actionString)) {                                                                        // 55
    return output;                                                                                                    // 56
  } else {                                                                                                            // 57
    return false;                                                                                                     // 58
  }                                                                                                                   // 59
}                                                                                                                     // 60
function handleGestureEvent (gestureName, event) {                                                                    // 61
  _.each(Object.keys(gestureHandlers[gestureName]), function (selector, index) {                                      // 62
    var eventElem = $(event.target).get(0);                                                                           // 63
    if ($(eventElem).is(selector)) {                                                                                  // 64
      gestureHandlers[gestureName][selector].call(Blaze.getData(eventElem), event);                                   // 65
    } else {                                                                                                          // 66
      var done = false;                                                                                               // 67
      _.each($(selector), function(selectorElem, index) {                                                             // 68
        if (!done && selectorElem && $.contains(selectorElem, eventElem)) {                                           // 69
          gestureHandlers[gestureName][selector].call(Blaze.getData(eventElem), event);                               // 70
          done = true;                                                                                                // 71
        }                                                                                                             // 72
      });                                                                                                             // 73
    }                                                                                                                 // 74
...
function setupTemplateGestures () {                                                                                   // 78
  var templateInstance = this,                                                                                        // 79
      template = templateInstance.view.template;                                                                      // 80
                                                                                                                      // 81
  if (checkGestureMap(template._gestures)) {                                                                          // 82
    _.each(template._gestures, function (handler, actionString) {                                                     // 83
      var actions = extractAction(actionString);                                                                      // 84
      _.each(actions, function (action) {                                                                             // 85
        var fullSelector = getTopSelector(templateInstance.$(action.elementSelector).parent()) + ' ' + action.elementSelector;
                                                                                                                      // 87
        /* Keep track of gesture handlers specific to this template instance */                                       // 88
        if (!templateInstance._activeGestureHandlers) {                                                               // 89
          templateInstance._activeGestureHandlers = [];                                                               // 90
        }                                                                                                             // 91
        templateInstance._activeGestureHandlers.push([action.gestureName, fullSelector]);                             // 92
                                                                                                                      // 93
        if (!gestureHandlers[action.gestureName]) {                                                                   // 94
          gestureHandlers[action.gestureName] = {};                                                                   // 95
          $('body').data('hammer').on(action.gestureName, _.partial(handleGestureEvent, action.gestureName));         // 96
        }                                                                                                             // 97
        gestureHandlers[action.gestureName][fullSelector] = function (event) {                                        // 98
          return handler.call(this, event, templateInstance);                                                         // 99
        };                                                                                                            // 100
      });                                                                                                             // 101
    });                                                                                                               // 102
  }                                                                                                                   // 103
}                                                                                                                     // 104
function teardownTemplateGestures () {                                                                                // 105
  var templateInstance = this,                                                                                        // 106
    template = templateInstance.view.template;                                                                        // 107
                                                                                                                      // 108
  if (templateInstance._activeGestureHandlers) {                                                                      // 109
    _.each(templateInstance._activeGestureHandlers, function (val, index) {                                           // 110
      var gestureName = val[0],                                                                                       // 111
          handlerId = val[1];                                                                                         // 112
                                                                                                                      // 113
      /* Clean up active gesture handlers for current template instance */                                            // 114
      gestureHandlers[gestureName][handlerId] = null;                                                                 // 115
      delete gestureHandlers[gestureName][handlerId];                                                                 // 116
      if (Object.keys(gestureHandlers[gestureName]) === 0) {                                                          // 117
        gestureHandlers[gestureName] = null;                                                                          // 118
        delete gestureHandlers[gestureName];                                                                          // 119
      }                                                                                                               // 120
    });                                                                                                               // 121
    templateInstance._activeGestureHandlers = null;                                                                   // 122
  }                                                                                                                   // 123
}                                                                                                                     // 124
Template.prototype.hammerOptions = function (hammerOptions) {                                                         // 125
  ...
  Meteor.startup(function () {                                                                                        // 127
    $('body').data('hammer').set(hammerOptions);                                                                      // 128
  });                                                                                                                 // 129
};                                                                                                                    // 130
Template.prototype.gestures = function (gestureMap) {                                                                 // 131
  if (checkGestureMap(gestureMap)) {                                                                                  // 132
    this._gestures = gestureMap;                                                                                      // 133
  }                                                                                                                   // 134
};                                                                                                                    // 135
Meteor.startup(function () {                                                                                          // 136
  $('body').hammer({});                                                                                               // 137
  Template.onRendered(setupTemplateGestures);                                                                         // 138
  Template.onDestroyed(teardownTemplateGestures);                                                                     // 139
});                                                                                                                   // 140
                                                                                                                      // 141
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                     // 2704
