...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                     //
// packages/tap_i18n/packages/tap_i18n.js                                                              //
//                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                       //
(function () {                                                                                         // 1
    ...
    var pluralExtensions = {                                                                                          // 1490
        ...
        rules: {                                                                                                      // 1492
            ...
            "sl": {                                                                                                   // 2344
                ...
                "plurals": function(n) { return Number(n%100==1 ? 1 : n%100==2 ? 2 : n%100==3 || n%100==4 ? 3 : 0); } // 2352
            },                                                                                                        // 2353
            "so": {                                                                                                   // 2354
                "name": "Somali",                                                                                     // 2355
                "numbers": [                                                                                          // 2356
                ...
                if ((match = /^[^\x25]+/.exec(_fmt)) !== null) {                                                      // 2665
                    ...
                    if (match[2]) {                                                                                   // 2672
                        ...
                        if ((field_match = /^([a-z_][a-z_\d]*)/i.exec(replacement_field)) !== null) {                 // 2675
                            ...
                            while ((replacement_field = replacement_field.substring(field_match[0].length)) !== '') { // 2677
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
__coffeescriptShare = typeof __coffeescriptShare === 'object' ? __coffeescriptShare : {}; var share = __coffeescriptShare;
var fallback_language;                                                                                 // 2841
                                                                                                       // 2842
fallback_language = globals.fallback_language;                                                         // 2843
                                                                                                       // 2844
TAPi18n = function() {                                                                                 // 2845
  EventEmitter.call(this);                                                                             // 2846
  this._fallback_language = fallback_language;                                                         // 2847
  this._language_changed_tracker = new Tracker.Dependency;                                             // 2848
  this._loaded_languages = [fallback_language];                                                        // 2849
  this.conf = null;                                                                                    // 2850
  this.packages = {};                                                                                  // 2851
  this.languages_names = {};                                                                           // 2852
  this.translations = {};                                                                              // 2853
  if (Meteor.isClient) {                                                                               // 2854
    Session.set(this._loaded_lang_session_key, null);                                                  // 2855
    this._languageSpecificTranslators = {};                                                            // 2856
    this._languageSpecificTranslatorsTrackers = {};                                                    // 2857
  }                                                                                                    // 2858
  if (Meteor.isServer) {                                                                               // 2859
    this.server_translators = {};                                                                      // 2860
    Meteor.startup((function(_this) {                                                                  // 2861
      return function() {                                                                              // 2862
        if (_this._enabled()) {                                                                        // 2863
          return _this._registerHTTPMethod();                                                          // 2864
        }                                                                                              // 2865
      };                                                                                               // 2866
    })(this));                                                                                         // 2867
  }                                                                                                    // 2868
  this.__ = this._getPackageI18nextProxy(globals.project_translations_domain);                         // 2869
  TAPi18next.setLng(fallback_language);                                                                // 2870
  return this;                                                                                         // 2871
};                                                                                                     // 2872
                                                                                                       // 2873
Util.inherits(TAPi18n, EventEmitter);                                                                  // 2874
                                                                                                       // 2875
_.extend(TAPi18n.prototype, {                                                                          // 2876
  _loaded_lang_session_key: "TAPi18n::loaded_lang",                                                    // 2877
  _enable: function(conf) {                                                                            // 2878
    this.conf = conf;                                                                                  // 2879
    return this._onceEnabled();                                                                        // 2880
  },                                                                                                   // 2881
  _onceEnabled: function() {},                                                                         // 2882
  _enabled: function() {                                                                               // 2883
    return this.conf != null;                                                                          // 2884
  },                                                                                                   // 2885
  _getPackageDomain: function(package_name) {                                                          // 2886
    return package_name.replace(/:/g, "-");                                                            // 2887
  },                                                                                                   // 2888
  addResourceBundle: function(lang_tag, package_name, translations) {                                  // 2889
    return TAPi18next.addResourceBundle(lang_tag, this._getPackageDomain(package_name), translations);
  },                                                                                                   // 2891
  _getSpecificLangTranslator: function(lang) {                                                         // 2892
    var current_lang, translator;                                                                      // 2893
    current_lang = TAPi18next.lng();                                                                   // 2894
    translator = null;                                                                                 // 2895
    TAPi18next.setLng(lang, {                                                                          // 2896
      fixLng: true                                                                                     // 2897
    }, (function(_this) {                                                                              // 2898
      return function(lang_translator) {                                                               // 2899
        return translator = lang_translator;                                                           // 2900
      };                                                                                               // 2901
    })(this));                                                                                         // 2902
    TAPi18next.setLng(current_lang);                                                                   // 2903
    return translator;                                                                                 // 2904
  },                                                                                                   // 2905
  _getProjectLanguages: function() {                                                                   // 2906
    if (this._enabled()) {                                                                             // 2907
      if (_.isArray(this.conf.supported_languages)) {                                                  // 2908
        return _.union([this._fallback_language], this.conf.supported_languages);                      // 2909
      } else {                                                                                         // 2910
        return _.keys(this.languages_names);                                                           // 2911
      }                                                                                                // 2912
    } else {                                                                                           // 2913
      return [this._fallback_language];                                                                // 2914
    }                                                                                                  // 2915
  },                                                                                                   // 2916
  getLanguages: function() {                                                                           // 2917
    var lang_tag, languages, _i, _len, _ref;                                                           // 2918
    if (!this._enabled()) {                                                                            // 2919
      return null;                                                                                     // 2920
    }                                                                                                  // 2921
    languages = {};                                                                                    // 2922
    _ref = this._getProjectLanguages();                                                                // 2923
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {                                                // 2924
      lang_tag = _ref[_i];                                                                             // 2925
      languages[lang_tag] = {                                                                          // 2926
        name: this.languages_names[lang_tag][1],                                                       // 2927
        en: this.languages_names[lang_tag][0]                                                          // 2928
      };                                                                                               // 2929
    }                                                                                                  // 2930
    return languages;                                                                                  // 2931
  },                                                                                                   // 2932
  _loadLangFileObject: function(language_tag, data) {                                                  // 2933
    var package_keys, package_name, _ref, _results;                                                    // 2934
    _results = [];                                                                                     // 2935
    for (package_name in data) {                                                                       // 2936
      package_keys = data[package_name];                                                               // 2937
      package_keys = _.extend({}, package_keys, ((_ref = this._loadTranslations_cache[language_tag]) != null ? _ref[package_name] : void 0) || {});
      _results.push(this.addResourceBundle(language_tag, package_name, package_keys));                 // 2939
    }                                                                                                  // 2940
    return _results;                                                                                   // 2941
  },                                                                                                   // 2942
  _loadTranslations_cache: {},                                                                         // 2943
  loadTranslations: function(translations, namespace) {                                                // 2944
    var language_tag, project_languages, translation_keys, _results;                                   // 2945
    project_languages = this._getProjectLanguages();                                                   // 2946
    _results = [];                                                                                     // 2947
    for (language_tag in translations) {                                                               // 2948
      translation_keys = translations[language_tag];                                                   // 2949
      if (this._loadTranslations_cache[language_tag] == null) {                                        // 2950
        this._loadTranslations_cache[language_tag] = {};                                               // 2951
      }                                                                                                // 2952
      if (this._loadTranslations_cache[language_tag][namespace] == null) {                             // 2953
        this._loadTranslations_cache[language_tag][namespace] = {};                                    // 2954
      }                                                                                                // 2955
      _.extend(this._loadTranslations_cache[language_tag][namespace], translation_keys);               // 2956
      this.addResourceBundle(language_tag, namespace, translation_keys);                               // 2957
      if (Meteor.isClient && this.getLanguage() === language_tag) {                                    // 2958
        _results.push(this._language_changed_tracker.changed());                                       // 2959
      } else {                                                                                         // 2960
        _results.push(void 0);                                                                         // 2961
      }                                                                                                // 2962
    }                                                                                                  // 2963
    return _results;                                                                                   // 2964
  }                                                                                                    // 2965
});                                                                                                    // 2966
                                                                                                       // 2967
                                                                                                       // 2968
...
var __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
  __slice = [].slice;                                                                                  // 2982
                                                                                                       // 2983
_.extend(TAPi18n.prototype, {                                                                          // 2984
  _languageSpecificTranslators: null,                                                                  // 2985
  _languageSpecificTranslatorsTrackers: null,                                                          // 2986
  _getLanguageFilePath: function(lang_tag) {                                                           // 2987
    var path;                                                                                          // 2988
    if (!this._enabled()) {                                                                            // 2989
      return null;                                                                                     // 2990
    }                                                                                                  // 2991
    path = this.conf.cdn_path != null ? this.conf.cdn_path : this.conf.i18n_files_route;               // 2992
    path = path.replace(/\/$/, "");                                                                    // 2993
    if (Meteor.isCordova && path[0] === "/") {                                                         // 2994
      path = Meteor.absoluteUrl().replace(/\/+$/, "") + path;                                          // 2995
    }                                                                                                  // 2996
    return "" + path + "/" + lang_tag + ".json";                                                       // 2997
  },                                                                                                   // 2998
  _loadLanguage: function(languageTag) {                                                               // 2999
    var dependencyLoadDfd, dfd, directDependencyLanguageTag, loadLanguageTag, project_languages;       // 3000
    dfd = new $.Deferred();                                                                            // 3001
    if (!this._enabled()) {                                                                            // 3002
      return dfd.reject("tap-i18n is not enabled in the project level, check tap-i18n README");        // 3003
    }                                                                                                  // 3004
    project_languages = this._getProjectLanguages();                                                   // 3005
    if (__indexOf.call(project_languages, languageTag) >= 0) {                                         // 3006
      if (__indexOf.call(this._loaded_languages, languageTag) < 0) {                                   // 3007
        loadLanguageTag = (function(_this) {                                                           // 3008
          return function() {                                                                          // 3009
            var jqXHR;                                                                                 // 3010
            jqXHR = $.getJSON(_this._getLanguageFilePath(languageTag));                                // 3011
            jqXHR.done(function(data) {                                                                // 3012
              _this._loadLangFileObject(languageTag, data);                                            // 3013
              _this._loaded_languages.push(languageTag);                                               // 3014
              return dfd.resolve();                                                                    // 3015
            });                                                                                        // 3016
            return jqXHR.fail(function(xhr, error_code) {                                              // 3017
              return dfd.reject("Couldn't load language '" + languageTag + "' JSON: " + error_code);   // 3018
            });                                                                                        // 3019
          };                                                                                           // 3020
        })(this);                                                                                      // 3021
        ...
        if (languageTag !== fallback_language && __indexOf.call(project_languages, directDependencyLanguageTag) >= 0) {
          dependencyLoadDfd = this._loadLanguage(directDependencyLanguageTag);                         // 3024
          dependencyLoadDfd.done((function(_this) {                                                    // 3025
            return function() {                                                                        // 3026
              return loadLanguageTag();                                                                // 3027
            };                                                                                         // 3028
          })(this));                                                                                   // 3029
          dependencyLoadDfd.fail((function(_this) {                                                    // 3030
            return function(message) {                                                                 // 3031
              return dfd.reject(("Loading process failed since dependency language '" + directDependencyLanguageTag + "' failed to load: ") + message);
            };                                                                                         // 3033
          })(this));                                                                                   // 3034
        } else {                                                                                       // 3035
          loadLanguageTag();                                                                           // 3036
        }                                                                                              // 3037
      } else {                                                                                         // 3038
        dfd.resolve();                                                                                 // 3039
      }                                                                                                // 3040
    } else {                                                                                           // 3041
      dfd.reject(["Language " + languageTag + " is not supported"]);                                   // 3042
    }                                                                                                  // 3043
    return dfd.promise();                                                                              // 3044
  },                                                                                                   // 3045
  _registerHelpers: function(package_name, template) {                                                 // 3046
    var helpers, tapI18nextProxy, underscore_helper;                                                   // 3047
    if (package_name !== globals.project_translations_domain) {                                        // 3048
      tapI18nextProxy = this._getPackageI18nextProxy(this.packages[package_name].namespace);           // 3049
    } else {                                                                                           // 3050
      tapI18nextProxy = this._getPackageI18nextProxy(globals.project_translations_domain);             // 3051
    }                                                                                                  // 3052
    underscore_helper = function() {                                                                   // 3053
      var args, key, options;                                                                          // 3054
      key = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];              // 3055
      options = (args.pop()).hash;                                                                     // 3056
      if (!_.isEmpty(args)) {                                                                          // 3057
        options.sprintf = args;                                                                        // 3058
      }                                                                                                // 3059
      return tapI18nextProxy(key, options);                                                            // 3060
    };                                                                                                 // 3061
    if (package_name !== globals.project_translations_domain) {                                        // 3062
      if ((Template[template] != null) && (Template[template].helpers != null)) {                      // 3063
        helpers = {};                                                                                  // 3064
        helpers[this.packages[package_name].helper_name] = underscore_helper;                          // 3065
        return Template[template].helpers(helpers);                                                    // 3066
      }                                                                                                // 3067
    } else {                                                                                           // 3068
      UI.registerHelper(this.conf.helper_name, underscore_helper);                                     // 3069
      return UI.registerHelper("languageTag", (function(_this) {                                       // 3070
        return function() {                                                                            // 3071
          return _this.getLanguage();                                                                  // 3072
        };                                                                                             // 3073
      })(this));                                                                                       // 3074
    }                                                                                                  // 3075
  },                                                                                                   // 3076
  _getRegisterHelpersProxy: function(package_name) {                                                   // 3077
    return (function(_this) {                                                                          // 3078
      return function(template) {                                                                      // 3079
        return _this._registerHelpers(package_name, template);                                         // 3080
      };                                                                                               // 3081
    })(this);                                                                                          // 3082
  },                                                                                                   // 3083
  _prepareLanguageSpecificTranslator: function(lang_tag) {                                             // 3084
    var dfd;                                                                                           // 3085
    dfd = (new $.Deferred()).resolve().promise();                                                      // 3086
    if (lang_tag in this._languageSpecificTranslatorsTrackers) {                                       // 3087
      return dfd;                                                                                      // 3088
    }                                                                                                  // 3089
    this._languageSpecificTranslatorsTrackers[lang_tag] = new Tracker.Dependency;                      // 3090
    if (!(lang_tag in this._languageSpecificTranslators)) {                                            // 3091
      dfd = this._loadLanguage(lang_tag).done((function(_this) {                                       // 3092
        return function() {                                                                            // 3093
          _this._languageSpecificTranslators[lang_tag] = _this._getSpecificLangTranslator(lang_tag);   // 3094
          return _this._languageSpecificTranslatorsTrackers[lang_tag].changed();                       // 3095
        };                                                                                             // 3096
      })(this));                                                                                       // 3097
    }                                                                                                  // 3098
    return dfd;                                                                                        // 3099
  },                                                                                                   // 3100
  _getPackageI18nextProxy: function(package_name) {                                                    // 3101
    return (function(_this) {                                                                          // 3102
      return function(key, options, lang_tag) {                                                        // 3103
        if (lang_tag == null) {                                                                        // 3104
          lang_tag = null;                                                                             // 3105
        }                                                                                              // 3106
        if (((options != null ? options.lang : void 0) != null) && ((options != null ? options.lng : void 0) == null)) {
          options.lng = options.lang;                                                                  // 3108
        }                                                                                              // 3109
        if (((options != null ? options.lng : void 0) != null) && (lang_tag == null)) {                // 3110
          lang_tag = options.lng;                                                                      // 3111
          delete options.lng;                                                                          // 3112
        }                                                                                              // 3113
        if (lang_tag != null) {                                                                        // 3114
          _this._prepareLanguageSpecificTranslator(lang_tag);                                          // 3115
          _this._languageSpecificTranslatorsTrackers[lang_tag].depend();                               // 3116
          if (lang_tag in _this._languageSpecificTranslators) {                                        // 3117
            return _this._languageSpecificTranslators[lang_tag]("" + (TAPi18n._getPackageDomain(package_name)) + ":" + key, options);
          } else {                                                                                     // 3119
            return TAPi18next.t("" + (TAPi18n._getPackageDomain(package_name)) + ":" + key, options);  // 3120
          }                                                                                            // 3121
        }                                                                                              // 3122
        _this._language_changed_tracker.depend();                                                      // 3123
        return TAPi18next.t("" + (TAPi18n._getPackageDomain(package_name)) + ":" + key, options);      // 3124
      };                                                                                               // 3125
    })(this);                                                                                          // 3126
  },                                                                                                   // 3127
  _onceEnabled: function() {                                                                           // 3128
    return this._registerHelpers(globals.project_translations_domain);                                 // 3129
  },                                                                                                   // 3130
  setLanguage: function(lang_tag) {                                                                    // 3131
    var self;                                                                                          // 3132
    self = this;                                                                                       // 3133
    return this._loadLanguage(lang_tag).then((function(_this) {                                        // 3134
      return function() {                                                                              // 3135
        TAPi18next.setLng(lang_tag);                                                                   // 3136
        _this._language_changed_tracker.changed();                                                     // 3137
        return Session.set(_this._loaded_lang_session_key, lang_tag);                                  // 3138
      };                                                                                               // 3139
    })(this));                                                                                         // 3140
  },                                                                                                   // 3141
  getLanguage: function() {                                                                            // 3142
    var session_lang;                                                                                  // 3143
    if (!this._enabled()) {                                                                            // 3144
      return null;                                                                                     // 3145
    }                                                                                                  // 3146
    session_lang = Session.get(this._loaded_lang_session_key);                                         // 3147
    if (session_lang != null) {                                                                        // 3148
      return session_lang;                                                                             // 3149
    } else {                                                                                           // 3150
      return this._fallback_language;                                                                  // 3151
    }                                                                                                  // 3152
  }                                                                                                    // 3153
});                                                                                                    // 3154
                                                                                                       // 3155
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/tap:i18n/lib/tap_i18n/tap_i18n-init.coffee.js                                                             //
// This file is in bare mode and is not in its own closure.                                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
