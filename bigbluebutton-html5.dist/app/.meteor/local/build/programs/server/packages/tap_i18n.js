...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
__coffeescriptShare = typeof __coffeescriptShare === 'object' ? __coffeescriptShare : {}; var share = __coffeescriptShare;
var fallback_language;                                                                                                // 2842
                                                                                                                      // 2843
fallback_language = globals.fallback_language;                                                                        // 2844
                                                                                                                      // 2845
TAPi18n = function() {                                                                                                // 2846
  EventEmitter.call(this);                                                                                            // 2847
  this._fallback_language = fallback_language;                                                                        // 2848
  this._language_changed_tracker = new Tracker.Dependency;                                                            // 2849
  this._loaded_languages = [fallback_language];                                                                       // 2850
  this.conf = null;                                                                                                   // 2851
  this.packages = {};                                                                                                 // 2852
  this.languages_names = {};                                                                                          // 2853
  this.translations = {};                                                                                             // 2854
  if (Meteor.isClient) {                                                                                              // 2855
    Session.set(this._loaded_lang_session_key, null);                                                                 // 2856
    this._languageSpecificTranslators = {};                                                                           // 2857
    this._languageSpecificTranslatorsTrackers = {};                                                                   // 2858
  }                                                                                                                   // 2859
  if (Meteor.isServer) {                                                                                              // 2860
    this.server_translators = {};                                                                                     // 2861
    Meteor.startup((function(_this) {                                                                                 // 2862
      return function() {                                                                                             // 2863
        if (_this._enabled()) {                                                                                       // 2864
          return _this._registerHTTPMethod();                                                                         // 2865
        }                                                                                                             // 2866
      };                                                                                                              // 2867
    })(this));                                                                                                        // 2868
  }                                                                                                                   // 2869
  this.__ = this._getPackageI18nextProxy(globals.project_translations_domain);                                        // 2870
  TAPi18next.setLng(fallback_language);                                                                               // 2871
  return this;                                                                                                        // 2872
};                                                                                                                    // 2873
                                                                                                                      // 2874
Util.inherits(TAPi18n, EventEmitter);                                                                                 // 2875
                                                                                                                      // 2876
_.extend(TAPi18n.prototype, {                                                                                         // 2877
  _loaded_lang_session_key: "TAPi18n::loaded_lang",                                                                   // 2878
  _enable: function(conf) {                                                                                           // 2879
    this.conf = conf;                                                                                                 // 2880
    return this._onceEnabled();                                                                                       // 2881
  },                                                                                                                  // 2882
  _onceEnabled: function() {},                                                                                        // 2883
  _enabled: function() {                                                                                              // 2884
    return this.conf != null;                                                                                         // 2885
  },                                                                                                                  // 2886
  _getPackageDomain: function(package_name) {                                                                         // 2887
    return package_name.replace(/:/g, "-");                                                                           // 2888
  },                                                                                                                  // 2889
  addResourceBundle: function(lang_tag, package_name, translations) {                                                 // 2890
    return TAPi18next.addResourceBundle(lang_tag, this._getPackageDomain(package_name), translations);                // 2891
  },                                                                                                                  // 2892
  _getSpecificLangTranslator: function(lang) {                                                                        // 2893
    var current_lang, translator;                                                                                     // 2894
    current_lang = TAPi18next.lng();                                                                                  // 2895
    translator = null;                                                                                                // 2896
    TAPi18next.setLng(lang, {                                                                                         // 2897
      fixLng: true                                                                                                    // 2898
    }, (function(_this) {                                                                                             // 2899
      return function(lang_translator) {                                                                              // 2900
        return translator = lang_translator;                                                                          // 2901
      };                                                                                                              // 2902
    })(this));                                                                                                        // 2903
    TAPi18next.setLng(current_lang);                                                                                  // 2904
    return translator;                                                                                                // 2905
  },                                                                                                                  // 2906
  _getProjectLanguages: function() {                                                                                  // 2907
    if (this._enabled()) {                                                                                            // 2908
      if (_.isArray(this.conf.supported_languages)) {                                                                 // 2909
        return _.union([this._fallback_language], this.conf.supported_languages);                                     // 2910
      } else {                                                                                                        // 2911
        return _.keys(this.languages_names);                                                                          // 2912
      }                                                                                                               // 2913
    } else {                                                                                                          // 2914
      return [this._fallback_language];                                                                               // 2915
    }                                                                                                                 // 2916
  },                                                                                                                  // 2917
  getLanguages: function() {                                                                                          // 2918
    var lang_tag, languages, _i, _len, _ref;                                                                          // 2919
    if (!this._enabled()) {                                                                                           // 2920
      return null;                                                                                                    // 2921
    }                                                                                                                 // 2922
    languages = {};                                                                                                   // 2923
    _ref = this._getProjectLanguages();                                                                               // 2924
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {                                                               // 2925
      lang_tag = _ref[_i];                                                                                            // 2926
      languages[lang_tag] = {                                                                                         // 2927
        name: this.languages_names[lang_tag][1],                                                                      // 2928
        en: this.languages_names[lang_tag][0]                                                                         // 2929
      };                                                                                                              // 2930
    }                                                                                                                 // 2931
    return languages;                                                                                                 // 2932
  },                                                                                                                  // 2933
  _loadLangFileObject: function(language_tag, data) {                                                                 // 2934
    var package_keys, package_name, _ref, _results;                                                                   // 2935
    _results = [];                                                                                                    // 2936
    for (package_name in data) {                                                                                      // 2937
      package_keys = data[package_name];                                                                              // 2938
      package_keys = _.extend({}, package_keys, ((_ref = this._loadTranslations_cache[language_tag]) != null ? _ref[package_name] : void 0) || {});
      _results.push(this.addResourceBundle(language_tag, package_name, package_keys));                                // 2940
    }                                                                                                                 // 2941
    return _results;                                                                                                  // 2942
  },                                                                                                                  // 2943
  _loadTranslations_cache: {},                                                                                        // 2944
  loadTranslations: function(translations, namespace) {                                                               // 2945
    var language_tag, project_languages, translation_keys, _results;                                                  // 2946
    project_languages = this._getProjectLanguages();                                                                  // 2947
    _results = [];                                                                                                    // 2948
    for (language_tag in translations) {                                                                              // 2949
      translation_keys = translations[language_tag];                                                                  // 2950
      if (this._loadTranslations_cache[language_tag] == null) {                                                       // 2951
        this._loadTranslations_cache[language_tag] = {};                                                              // 2952
      }                                                                                                               // 2953
      if (this._loadTranslations_cache[language_tag][namespace] == null) {                                            // 2954
        this._loadTranslations_cache[language_tag][namespace] = {};                                                   // 2955
      }                                                                                                               // 2956
      _.extend(this._loadTranslations_cache[language_tag][namespace], translation_keys);                              // 2957
      this.addResourceBundle(language_tag, namespace, translation_keys);                                              // 2958
      if (Meteor.isClient && this.getLanguage() === language_tag) {                                                   // 2959
        _results.push(this._language_changed_tracker.changed());                                                      // 2960
      } else {                                                                                                        // 2961
        _results.push(void 0);                                                                                        // 2962
      }                                                                                                               // 2963
    }                                                                                                                 // 2964
    return _results;                                                                                                  // 2965
  }                                                                                                                   // 2966
});                                                                                                                   // 2967
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      // 2969
...
var __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
                                                                                                                      // 2987
_.extend(TAPi18n.prototype, {                                                                                         // 2988
  server_translators: null,                                                                                           // 2989
  _registerServerTranslator: function(lang_tag, package_name) {                                                       // 2990
    if (this._enabled()) {                                                                                            // 2991
      if (!(lang_tag in this.server_translators)) {                                                                   // 2992
        this.server_translators[lang_tag] = this._getSpecificLangTranslator(lang_tag);                                // 2993
      }                                                                                                               // 2994
      if (lang_tag !== this._fallback_language) {                                                                     // 2995
        this.addResourceBundle(lang_tag, package_name, this.translations[lang_tag][package_name]);                    // 2996
      }                                                                                                               // 2997
    }                                                                                                                 // 2998
    if (!(this._fallback_language in this.server_translators)) {                                                      // 2999
      return this.server_translators[this._fallback_language] = this._getSpecificLangTranslator(this._fallback_language);
    }                                                                                                                 // 3001
  },                                                                                                                  // 3002
  _registerAllServerTranslators: function() {                                                                         // 3003
    var lang_tag, package_name, _i, _len, _ref, _results;                                                             // 3004
    _ref = this._getProjectLanguages();                                                                               // 3005
    _results = [];                                                                                                    // 3006
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {                                                               // 3007
      lang_tag = _ref[_i];                                                                                            // 3008
      _results.push((function() {                                                                                     // 3009
        var _results1;                                                                                                // 3010
        _results1 = [];                                                                                               // 3011
        for (package_name in this.translations[lang_tag]) {                                                           // 3012
          _results1.push(this._registerServerTranslator(lang_tag, package_name));                                     // 3013
        }                                                                                                             // 3014
        return _results1;                                                                                             // 3015
      }).call(this));                                                                                                 // 3016
    }                                                                                                                 // 3017
    return _results;                                                                                                  // 3018
  },                                                                                                                  // 3019
  _getPackageI18nextProxy: function(package_name) {                                                                   // 3020
    return (function(_this) {                                                                                         // 3021
      return function(key, options, lang_tag) {                                                                       // 3022
        if (lang_tag == null) {                                                                                       // 3023
          lang_tag = null;                                                                                            // 3024
        }                                                                                                             // 3025
        if (lang_tag == null) {                                                                                       // 3026
          return _this.server_translators[_this._fallback_language]("" + (_this._getPackageDomain(package_name)) + ":" + key, options);
        } else if (!(lang_tag in _this.server_translators)) {                                                         // 3028
  ...
  _registerHTTPMethod: function() {                                                                                   // 3037
    var methods, self;                                                                                                // 3038
    self = this;                                                                                                      // 3039
    methods = {};                                                                                                     // 3040
    if (!self._enabled()) {                                                                                           // 3041
      throw new Meteor.Error(500, "tap-i18n has to be enabled in order to register the HTTP method");                 // 3042
    }                                                                                                                 // 3043
    methods["" + (self.conf.i18n_files_route.replace(/\/$/, "")) + "/multi/:langs"] = {                               // 3044
      get: function() {                                                                                               // 3045
        var lang_tag, langs, language_translations, output, _i, _len;                                                 // 3046
        if (!RegExp("^((" + globals.langauges_tags_regex + ",)*" + globals.langauges_tags_regex + "|all).json$").test(this.params.langs)) {
          return this.setStatusCode(401);                                                                             // 3048
        }                                                                                                             // 3049
        langs = this.params.langs.replace(".json", "");                                                               // 3050
        if (langs === "all") {                                                                                        // 3051
          output = self.translations;                                                                                 // 3052
        } else {                                                                                                      // 3053
          output = {};                                                                                                // 3054
          langs = langs.split(",");                                                                                   // 3055
          for (_i = 0, _len = langs.length; _i < _len; _i++) {                                                        // 3056
            lang_tag = langs[_i];                                                                                     // 3057
            if (__indexOf.call(self._getProjectLanguages(), lang_tag) >= 0 && lang_tag !== self._fallback_language) {
              language_translations = self.translations[lang_tag];                                                    // 3059
              if (language_translations != null) {                                                                    // 3060
                output[lang_tag] = language_translations;                                                             // 3061
              }                                                                                                       // 3062
            }                                                                                                         // 3063
          }                                                                                                           // 3064
        }                                                                                                             // 3065
        return JSON.stringify(output);                                                                                // 3066
      }                                                                                                               // 3067
    };                                                                                                                // 3068
    methods["" + (self.conf.i18n_files_route.replace(/\/$/, "")) + "/:lang"] = {                                      // 3069
      get: function() {                                                                                               // 3070
        var lang_tag, language_translations;                                                                          // 3071
        if (!RegExp("^" + globals.langauges_tags_regex + ".json$").test(this.params.lang)) {                          // 3072
          return this.setStatusCode(401);                                                                             // 3073
        }                                                                                                             // 3074
        lang_tag = this.params.lang.replace(".json", "");                                                             // 3075
        if (__indexOf.call(self._getProjectLanguages(), lang_tag) < 0 || lang_tag === self._fallback_language) {      // 3076
          return this.setStatusCode(404);                                                                             // 3077
        }                                                                                                             // 3078
        language_translations = self.translations[lang_tag];                                                          // 3079
        return JSON.stringify(language_translations != null ? language_translations : {});                            // 3080
      }                                                                                                               // 3081
    };                                                                                                                // 3082
    return HTTP.methods(methods);                                                                                     // 3083
  },                                                                                                                  // 3084
  _onceEnabled: function() {                                                                                          // 3085
    return this._registerAllServerTranslators();                                                                      // 3086
  }                                                                                                                   // 3087
});                                                                                                                   // 3088
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      // 3090
