    ...
    if (shouldRunFramework('jasmine-server-integration')) {                                                           // 36
      Meteor.startup(function () {                                                                                    // 37
        ...
        Meteor.startup(function () {                                                                                  // 39
          frameworks.serverIntegration.start()                                                                        // 40
        })                                                                                                            // 41
      })                                                                                                              // 42
    }                                                                                                                 // 43
  }                                                                                                                   // 44
                                                                                                                      // 45
                                                                                                                      // 46
  // Client Integration                                                                                               // 47
  if (process.env.JASMINE_CLIENT_INTEGRATION !== '0') {                                                               // 48
    frameworks.clientIntegration = new ClientIntegrationTestFramework()                                               // 49
                                                                                                                      // 50
    if (isMainApp()) {                                                                                                // 51
      frameworks.clientIntegration.registerWithVelocity()                                                             // 52
      Velocity.startup(function () {                                                                                  // 53
        // In test packages mode this does not really create a new mirror                                             // 54
        // It just registers the app as mirror.                                                                       // 55
        frameworks.clientIntegration.startMirror()                                                                    // 56
      })                                                                                                              // 57
    }                                                                                                                 // 58
  }                                                                                                                   // 59
                                                                                                                      // 60
                                                                                                                      // 61
  // Client Unit                                                                                                      // 62
  if (process.env.JASMINE_CLIENT_UNIT !== '0' && !isTestPackagesMode()) {                                             // 63
    frameworks.clientUnit = new ClientUnitTestFramework()                                                             // 64
                                                                                                                      // 65
    if (isMainApp()) {                                                                                                // 66
      frameworks.clientUnit.registerWithVelocity()                                                                    // 67
      Velocity.startup(function () {                                                                                  // 68
        frameworks.clientUnit.start()                                                                                 // 69
      })                                                                                                              // 70
    }                                                                                                                 // 71
  }                                                                                                                   // 72
                                                                                                                      // 73
                                                                                                                      // 74
  // Server Unit                                                                                                      // 75
  if (process.env.JASMINE_SERVER_UNIT === '1' && !isTestPackagesMode()) {                                             // 76
    frameworks.serverUnit = new ServerUnitTestFramework()                                                             // 77
                                                                                                                      // 78
    if (isMainApp()) {                                                                                                // 79
      frameworks.serverUnit.registerWithVelocity()                                                                    // 80
      Velocity.startup(function () {                                                                                  // 81
        frameworks.serverUnit.start()                                                                                 // 82
      })                                                                                                              // 83
    }                                                                                                                 // 84
  }                                                                                                                   // 85
                                                                                                                      // 86
                                                                                                                      ...
                                                                                                                      // 88
Jasmine.setKarmaConfig = function (config) {                                                                          // 89
  if (frameworks.clientUnit && isMainApp()) {                                                                         // 90
    frameworks.clientUnit.setUserKarmaConfig(config)                                                                  // 91
  }                                                                                                                   // 92
}                                                                                                                     // 93
                                                                                                                      // 94
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
